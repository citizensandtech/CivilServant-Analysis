...
########################################################
########## GENERATE EXTENDED EXPERIMENT RANDOMIZATIONS ##########
########################################################
observations = 660 + 144 # enough randomizations allowing for 12 blocks to be spoiled
arms = 3
block.sizes = 4
...
write.table(randomizations, "outputs/sticky_comment_worldnews_0.randomizations_extensions.csv", sep = ",", col.names = NA)
#write.table(randomizations, "sticky_comment_worldnews_0.randomizations_extensions.csv", sep = ",", col.names = NA)
